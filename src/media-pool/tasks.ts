import { CLASS_MEDIA_POOL_ELEMENT } from "./constants";

export class MediaTaskQueue<T extends HTMLMediaElement> {
    private media: T;
    ...
    async run(media: HTMLMediaElement): Promise<void> {
        ...
        for (const source of this.sources) {
            ...
            try{
                ...
                console.log("Append error update sources task", err)
            }
...
export class AddToDomTask extends MediaTask {
    ...
    async run(media: HTMLMediaElement): Promise<void> {
        ...
        const existing = this.parent.querySelector(
